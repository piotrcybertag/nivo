    ...
    <div class="landing-hero">
        ...
        @else
            <div class="landing-cta-wrap">
                ...
                <a href="{{ route('rejestracja', ['plan' => 'free']) }}" class="landing-cta landing-cta--secondary">Zarejestruj do Planu FREE</a>
            </div>
        @endif
    </div>
...
<style>
    ...
    .landing-cta-wrap { display: flex; flex-wrap: wrap; gap: 0.75rem 1rem; justify-content: center; align-items: center; }
    ...
    .landing-cta--secondary { background: #0f172a; box-shadow: 0 2px 8px rgba(15, 23, 42, 0.25); }
    .landing-cta--secondary:hover { background: #1e293b; }
